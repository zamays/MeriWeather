...
def get_historical_observations(station_id, start_date, end_date):
    ...
    logger.info(f"Requesting observations for station {station_id} from {start_date.isoformat()} to {end_date.isoformat()}")
    ...
    try:
        ...
        logger.info(f"Retrieved {observation_count} observations for station {station_id}")
        return data
